...
namespace Artwork
{
    ...
    public class QuadTreeNode
    {
        ...
        public void Draw(TilingLibrary.Compatibility.GraphicsInterface graphics, bool drawcontained = true)
        {
            ...
            else
            {
                if (contained == 0)
                {
                    graphics.DrawRectangle(new Primitives.Pen(Color.Yellow, 1), xstart, ystart, xend - xstart - 1, yend - ystart - 1);
                }
            }
        ...
        public void DrawArt(TilingLibrary.Compatibility.GraphicsInterface graphics, Color Col)
        {
            if (contained == 0)
            {
