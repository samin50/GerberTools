...
namespace Artwork
{
    public class Settings
    {
        ...
        public Artwork.Tiling.TilingType TileType { get; set; } = Artwork.Tiling.TilingType.Danzer7Fold;
        public int BaseTile { get; set; } = 0;
        public ArtMode Mode { get; set; } = ArtMode.Tiling;
        public int MaxSubDiv { get; set; } = 5;
        public float DegreesOff { get; set; } = 0;
        public Random Rand { get; set; } = new Random();
        public int Threshold { get; set; } = 30;
        public bool InvertSource { get; set; } = false;
        public bool InvertOutput { get; set; } = false;

        public bool ReloadMask { get; set; } = false;
        public Color BackGroundColor { get; set; } = Color.Black;
        public Color BackgroundHighlight { get; set; }
        public int scalesmaller { get; set; }
        public bool alwayssubdivide { get; set; }
        public int scalesmallerlevel { get; set; }
        public bool Symmetry { get; set; }
        public bool SuperSymmetry { get; set; }
        public int xscalesmallerlevel { get; set; }
        public int xscalecenter { get; set; }

        public float scalesmallerfactor { get; set; } = 1.0f;
        public TriangleScaleMode scalingMode { get; set; } = TriangleScaleMode.Balanced;
        public float distanceToMaskScale { get; set; }
        public float distanceToMaskRange { get; set; }
        public bool MarcelPlating { get; set; } = false;
        public float BallRadius { get; set; } = 2000;
        public float Gap { get; set; } = 6000;
        public float Rounding { get; set; } = 8000;
        public string DistanceMaskFile { get; set; } = "";
    ...
    public class Tiling
    {
        ...
        public class Polygon
        {
            ...
            public Color GetColor()
            {
                ...
                return Color.FromRgba((byte)R, (byte)G, (byte)B, 255);
            }
        ...
        public class Triangle
        {
            ...
            public void Render(Graphics G, int Depth = 5)
            {
                ...
                Color Cl = Color.Red;
                Color Cl2 = Color.FromRgba((byte)0, (byte)0, (byte)0, (byte)100);
                switch (type)
                {
                    ...
                    case 0: dAB = false; dBC = false; dCA = false; Cl = Color.FromRgba((byte)0xcc, (byte)0xca, (byte)0xe4, 255); break;
                    case 1: dAB = true; dBC = false; dCA = false; Cl = Color.FromRgba((byte)0xfc, (byte)0x66, (byte)0x13, 255); break;
                    case 2: dAB = true; dBC = true; dCA = true; Cl = Color.FromRgba((byte)0xfc, (byte)0xca, (byte)0x64, 255); break;

                    case 5: Cl = Color.Red; break;
                }

                Pen P = new Pen(Cl2, 2);
                P.EndCap = Primitives.LineCap.Round;
                P.LineJoin = Primitives.LineJoin.Round;
