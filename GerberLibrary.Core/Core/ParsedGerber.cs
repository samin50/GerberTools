...
namespace GerberLibrary.Core
{
    public class ParsedGerber
    {
        ...
        public List<GerberLibrary.Core.Primitives.Triangle> ShapeCacheTriangles = new List<GerberLibrary.Core.Primitives.Triangle>();
            ...
            foreach (var a in OutlineShapes)
            {
                if (a.Hole == false)
                {
                    ...
                    foreach (var t in mesh.Triangles)
                    {
                        ...
                        var B = t.GetVertex(1);
                        var C = t.GetVertex(2);
                        ShapeCacheTriangles.Add(new GerberLibrary.Core.Primitives.Triangle()
                        {
