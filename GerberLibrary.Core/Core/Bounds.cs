...
namespace GerberLibrary
{
    ...
    public class Bounds
    {
        ...
        public float GenerateTransform(GraphicsInterface g, int width, int height, int margin, bool flipY = false)
        {
            if (Valid == false)
            {
                return 1;
        ...
        public float GenerateTransformWithScaleOffset(GraphicsInterface g2, int width, int height, int margin, bool flipy, float scale, PointF offset)
        {
